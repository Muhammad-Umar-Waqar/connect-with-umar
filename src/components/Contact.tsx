...
function Contact() {
  ...
  <div className="mt-[100px]" id="contact">
    ...
    <div className="flex  md:flex-row flex-col  items-center justify-center md:space-x-10 mt-[64px]">
      <div>
      <button className="flex bg-pink-50 h-[70px] min-w-[290px]   rounded-xl items-center p-[16px]">
      ...
      <div className="">
      <button className="flex bg-blue-50 h-[70px] min-w-[290px] md:mt-[0] mt-[20px]   rounded-xl items-center p-[16px]">
    ...
    <div className="flex flex-col gap-5 items-center justify-center mt-[70px]">
      <div>
        ...
        <div>
          <Button type="submit" variant="destructive" className="p-[5px ] h-[50px] mb-[60px]" >Send Message</Button>
        </div>
    </div>
      </form>
